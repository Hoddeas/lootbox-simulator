...
var mythicalItems = ["Hades' Ghastly Bow(Mythical)", "Haphaestus' Golden Leggings(Mythical)", "God Slaying Sword(Mythical)", "Hades' Swift Sandals", "Ares' Crested Chestplate(Mythical)"];
